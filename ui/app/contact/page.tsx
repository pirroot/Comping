...
const contactInfo = [
  ...
  },
  {
    ...
    title: 'تلفن پشتیبانی',
    value: '۰۲۱-۱۲۳۴۵۶۷۸',
    detail: 'پاسخ‌گویی در ساعات کاری',
  },
  {
    icon: Mail,
    title: 'ایمیل',
    value: 'info@comping.ir',
    detail: 'پاسخ‌گویی حداکثر تا ۲۴ ساعت',
  },
];
      ...
      <section className="relative overflow-hidden bg-[#123d34] px-4 pt-12 pb-16 text-white sm:pt-16 sm:pb-20">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <p className="mt-5 max-w-xl text-sm leading-8 text-white/70 sm:text-base">
            سوالی درباره محصولات، سفارش یا انتخاب تجهیزات داری؟ تیم ما اینجاست
            تا سریع و دقیق راهنمایی‌ات کند.
          </p>
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6">
        <section className="-mt-8 grid gap-6 lg:grid-cols-[1fr_1.15fr]">
          <div className="rounded-3xl bg-[#123d34] p-6 text-white shadow-xl shadow-[#123d34]/15 sm:p-8">
            <p className="text-primary_light text-sm font-medium">
              راه‌های ارتباطی
            </p>
            <h2 className="mt-2 text-2xl font-extrabold">
              هر طور راحت‌تری با ما در تماس باش
            </h2>
            <p className="mt-3 text-sm leading-7 text-white/65">
              برای پیگیری سفارش یا دریافت مشاوره خرید، یکی از راه‌های زیر را
              انتخاب کن.
            </p>
            ...
            <div className="bg-auxiliary text-text mt-7 rounded-2xl p-4 text-sm leading-7 font-bold">
              <span className="block text-xs font-medium opacity-70">
                پشتیبانی سفارش‌ها
              </span>
              اگر درباره سفارش فعلی‌ات سوال داری، شماره سفارش را در پیام خودت
              بنویس.
            </div>
          </div>
          ...
          <div className="border-neutral_normal rounded-3xl border bg-white p-6 shadow-sm sm:p-8">
            <div className="mb-7">
              <p className="text-primary text-sm font-medium">پیام جدید</p>
              <h2 className="text-text mt-2 text-2xl font-extrabold">
                چطور می‌توانیم کمکت کنیم؟
              </h2>
            ...
            {sent ? (
              <div className="bg-primary_light/60 flex min-h-72 flex-col items-center justify-center rounded-2xl px-5 text-center">
                <span className="bg-primary flex h-14 w-14 items-center justify-center rounded-full text-white">
                  <Check size={28} />
                </span>
                ...
                <p className="text-neutral_dark mt-2 text-sm leading-7">
                  ممنون که با ما در تماس هستی. تیم پشتیبانی تا ۲۴ ساعت آینده
                  پاسخ می‌دهد.
                </p>
                <button
                  type="button"
                  onClick={() => setSent(false)}
                  className="text-primary mt-5 text-sm font-bold"
                >
                  ارسال پیام جدید
                </button>
              </div>
                ...
                <div className="sm:col-span-2">
                  <label className="block">
                    ...
                    <textarea
                      ...
                      className="border-neutral_normal text-text placeholder:text-neutral_dark/60 focus:border-primary focus:ring-primary/10 min-h-36 w-full resize-y rounded-xl border bg-[#fbfcfb] px-4 py-3 text-sm leading-7 transition outline-none focus:ring-4"
                    />
                  </label>
                </div>
                <div className="flex items-center justify-between gap-4 sm:col-span-2">
                  <p className="text-neutral_dark text-xs leading-6">
                    اطلاعات شما فقط برای پاسخ‌گویی به همین پیام استفاده می‌شود.
                  </p>
                  <button
                    type="submit"
                    className="bg-primary flex shrink-0 items-center gap-2 rounded-xl px-5 py-3 text-sm font-bold text-white transition hover:bg-[#5a9a63]"
                  >
        ...
        <section className="mt-8 grid gap-6 md:grid-cols-[1.15fr_1fr]">
          <div className="border-neutral_normal relative min-h-64 overflow-hidden rounded-3xl border bg-[#e7f2e9] p-7">
            <div className="border-primary/15 absolute -top-12 -left-12 h-44 w-44 rounded-full border-18" />
            <div className="relative">
              <p className="text-primary text-sm font-medium">ما اینجاییم</p>
              <h2 className="text-text mt-2 text-2xl font-extrabold">
                به فروشگاه کمپینک سر بزن
              </h2>
              <p className="text-neutral_dark mt-3 max-w-md text-sm leading-7">
                برای مشاوره نزدیک‌تر می‌توانی به فروشگاه ما در تهران مراجعه کنی.
              </p>
              <div className="text-text mt-6 flex items-center gap-2 text-sm font-bold">
                <MapPin size={18} className="text-primary" /> خیابان ولیعصر،
                پلاک ۱۲۳
              </div>
            </div>
          </div>
          <div className="border-neutral_normal rounded-3xl border bg-white p-7 shadow-sm">
            <h2 className="text-text text-xl font-extrabold">
              قبل از پیام، این‌ها را ببین
            </h2>
            <p className="text-neutral_dark mt-2 text-sm leading-7">
...
function QuickAnswer({ title }: { title: string }) {
  return (
    <div className="bg-neutral_light text-text flex items-center justify-between gap-3 rounded-xl px-4 py-3 text-sm font-medium">
      <span>{title}</span>
