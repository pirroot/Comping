  ...
  return (
    <section className="container mx-auto px-4 py-10 md:py-14">
      <div className="relative overflow-hidden rounded-4xl bg-[#123d34] shadow-xl shadow-[#123d34]/10">
        <div className="border-primary/20 pointer-events-none absolute -top-28 -left-24 h-64 w-64 rounded-full border-24" />
        <div className="border-auxiliary/10 pointer-events-none absolute right-1/3 -bottom-40 h-72 w-72 rounded-full border-28" />
        <div className="absolute top-0 left-1/2 z-20 flex h-10 w-10 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white shadow-sm backdrop-blur-sm">
          <ChevronDown size={17} />
        </div>
        ...
        <div className="relative z-10 px-5 py-10 sm:px-8 md:px-10 md:py-14">
          <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
            <div>
              <p className="text-primary_light mb-2 text-xs font-medium">
              ...
              {categories.map((category) => (
                ...
                >
                  <div className="group relative flex h-full min-h-52 flex-col items-center justify-center rounded-3xl border border-white/70 bg-white p-5 text-center shadow-lg shadow-black/10 transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-2xl sm:p-6 md:rounded-4xl">
                    <div className="bg-primary/30 group-hover:bg-auxiliary absolute top-4 right-4 h-2 w-2 rounded-full transition" />
                    <div className="bg-neutral_light relative mb-4 aspect-square w-full max-w-24 rounded-2xl p-2 transition-transform duration-300 ease-out group-hover:scale-110 sm:max-w-28 md:max-w-30">
                      <Image
                        src={category.image}
                        alt={category.title}
                        fill
                    ...
                    <h3 className="text-text text-sm font-extrabold sm:text-base md:text-lg">
                      {category.title}
                    </h3>
                  </div>
                </div>
      ...
      {/* Description */}
      <p className="text-neutral_dark mx-auto mt-8 max-w-3xl text-center text-sm leading-8 md:text-base">
